...
import useShareProjectDialog from './useShareProjectDialog';
...
const messages = defineMessages({
  ...
  shareProjectTooltip: {
    ...
    description: 'Tooltip and screen reader label for the share project button',
...
function ProjectList(_props: Props) {
  ...
  const shareProject = useShareProjectDialog(confirmShareProject,localProjects)
  async function confirmShareProject(localProject: Project): Promise <booolean>{
  ...
  return (
    <div className={s.container}>
      <Paper className={s.root}>
        ...
        <SimpleDialog id="share-dialog" {...shareProject.mountSimpleDialog()} />
