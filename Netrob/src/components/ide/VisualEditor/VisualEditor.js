    ...
    const toolbox = ReactDOM.renderToStaticMarkup(
      <xml>
        ...
        <category name="Tooling" colour="120">
          ...
          {miscBlocks.CRCL_ACCELERATION.toolboxBlocks.default()}
          {miscBlocks.CRCL_TOOL_ON_OFF.toolboxBlocks.default()}
        ...
        {miscBlocks.CRCL_ROTATE_Z.toolboxBlocks.default()}  
          ...
          {miscBlocks.VECTOR_OPERATION.toolboxBlocks.default()}
          
         
          {miscBlocks.CRCL_WAIT.toolboxBlocks.default()}
